...
export const environment = {
  ...
  url_projects_users: baseUrl + '/' + usedApi + '/projects/users',
  url_tasks: baseUrl + '/' + usedApi + '/tasks',
  url_task_assignedUser: baseUrl + '/' + usedApi + '/task/assignedUser',
  url_task_processPoints: baseUrl + '/' + usedApi + '/task/processPoints'
};
