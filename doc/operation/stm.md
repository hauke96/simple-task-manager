...
| `osm-base-url`             | `STM_OSM_BASE_URL`             | -           | No       | URL to the OSM server (e.g. `https://www.openstreetmap.org`) as used by the end-user, which is used for login.                                   |
| `osm-api-url`              | `STM_OSM_API_URL`              | -           | No       | URL to the API path of the OSM server (e.g. `https://api.openstreetmap.org/api/0.6`).                                                            |
...
| `db-database`              | `STM_DB_DATABASE`              | `stm`       | No       | Name of the database to use.                                                                                                                     |
